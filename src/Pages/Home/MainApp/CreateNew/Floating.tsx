    ...
    <>
      {clicked && (
        <div className="complete-floating w-screen h-screen flex items-center justify-center backdrop-blur-sm fixed top-0 left-0 z-100">
          <div
            className="test-page p-4 rounded-md bg-secondary w-[500px] max-h-[600px] h-auto flex flex-col items-center justify-center shadow-[2px_2px_5px_rgba(0,0,0,0.3)] gap-0 relative"
            ref={floatref}
          >
            <button
